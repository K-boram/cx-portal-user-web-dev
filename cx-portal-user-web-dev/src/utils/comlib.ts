 ...
 */
export function makeMockupPagingData<T extends { params: any }, K extends { body: any }>(req: T, data: K) {
  ...
  const copyData: K & T['params'] = { ...data, currentPage: req.params.currentPage, limit: req.params.limit }
